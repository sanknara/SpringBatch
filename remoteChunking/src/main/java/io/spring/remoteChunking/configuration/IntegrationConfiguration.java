...
public class IntegrationConfiguration {
    ...
    @Bean
    public ChunkHandler chunkHandler(TaskletStep slaveStep) throws Exception{
    ...
    public MessagingTemplate messageTemplate(){
        MessagingTemplate mt = new MessagingTemplate(outboundRequests());

        mt.setReceiveTimeout(600000000l);
    ...
    @Bean
    public MessageChannel outboundRequests() { return new DirectChannel(); }
    ...
    public ChunkProcessorChunkHandler chunkProcessorChunkHandler(ItemProcessor<Customer, Customer> itemProcessor,
                                                                 ItemWriter<Customer> itemWriter) throws Exception {
    ...
    @Bean
    public MessageChannel inboundRequests() { return new QueueChannel();}
    ...
    @Bean
    public QueueChannel inboundReplies() { return new QueueChannel(); }

    @Bean
    public QueueChannel outboundReplies() { return new QueueChannel(); }

    @Bean
    @Profile("master")
    public AmqpInboundChannelAdapter inboundRepliesAdapter(SimpleMessageListenerContainer container){
