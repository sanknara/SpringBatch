...
public class IntegrationConfiguration {
    ...
    public MessagingTemplate messagingTemplate(){
        ...
        mt.setReceiveTimeout(6000000000l);
        return messagingTemplate();
    }

    @Bean
    public DirectChannel outboundReqests() { return new DirectChannel(); }
    ...
    @Bean
    public PollableChannel outboundStaging() { return new NullChannel(); }
